...
class TriviaCardIntermedio extends StatefulWidget {
  const TriviaCardIntermedio({
    required this.user,
    super.key,
  });
  final User user;
  ...
  @override
  State<TriviaCardIntermedio> createState() => _TriviaCardIntermedioState();
}

class _TriviaCardIntermedioState extends State<TriviaCardIntermedio> {
  ...
  Future<void> _loadInitialData() async {
    try {
      final juegos = await IsJuegosServices().getJuegosInterm(
    ...
    return StreamBuilder<JuegosModel>(
      ...
      builder: (BuildContext context, AsyncSnapshot<JuegosModel> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          myLongPrint('Juegos Intermedios: ${juegos!.body!.toSet().toList()}');
