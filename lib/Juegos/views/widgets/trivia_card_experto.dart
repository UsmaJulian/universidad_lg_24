...
class TriviaCardExperto extends StatefulWidget {
  ...
  @override
  State<TriviaCardExperto> createState() => _TriviaCardExpertoState();
}

class _TriviaCardExpertoState extends State<TriviaCardExperto> {
  ...
  Future<void> _loadInitialData() async {
    try {
      final juegos = await IsJuegosServices().getJuegosAvanz(
